        ...
        <div class="container px-5">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" href="../../src/View/rooms.php">Home</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="../../src/View/my_reservations.php">Moje rezerwacje</a></li>
                    <li class="nav-item">
